...
public class CustomItemFilterContainer implements INBTSerializable<NBTTagCompound> {
    ...
    public CustomItemFilterContainer(IDirtyNotifiable dirtyNotifiable) {
    ...
    public void initUI(int y, Consumer<Widget> widgetGroup, BooleanSupplier canTakeDelegate) {
        widgetGroup.accept(new LabelWidget(10, y, "cover.conveyor.item_filter.title"));
        widgetGroup.accept(new CustomSlotWidget(filterInventory, 0, 10, y + 15, "Item", canTakeDelegate)
