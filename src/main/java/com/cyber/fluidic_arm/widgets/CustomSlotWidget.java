package com.cyber.fluidic_arm.widgets;
...
public class CustomSlotWidget extends Widget implements INativeWidget {
    ...
    protected Consumer<CustomSlotWidget> consumer;

    private String name;
    public BooleanSupplier displaySupplier;

    public CustomSlotWidget(IInventory inventory, int slotIndex, int xPosition, int yPosition, boolean canTakeItems, boolean canPutItems) {
    ...
    public CustomSlotWidget(IItemHandler itemHandler, int slotIndex, int xPosition, int yPosition, boolean canTakeItems, boolean canPutItems) {
        super(new Position(xPosition, yPosition), new Size(18, 18));
        this.canTakeItems = canTakeItems;
        this.canPutItems = canPutItems;
    ...
    public CustomSlotWidget(IItemHandler itemHandler, int slotIndex, int xPosition, int yPosition, boolean canTakeItems, boolean canPutItems, boolean canShiftClickInto) {
        super(new Position(xPosition, yPosition), new Size(18, 18));
        this.canTakeItems = canTakeItems;
        this.canPutItems = canPutItems;
    ...
    public CustomSlotWidget(IItemHandlerModifiable itemHandler, int slotIndex, int xPosition, int yPosition, String name, BooleanSupplier displaySupplier) {
        this(itemHandler, slotIndex, xPosition, yPosition, true, true);
        this.name = name;
        this.displaySupplier = displaySupplier;
    }

    public CustomSlotWidget(IInventory inventory, int slotIndex, int xPosition, int yPosition) {
    ...
    public CustomSlotWidget setConsumer(Consumer<CustomSlotWidget> consumer) {
        this.consumer = consumer;
        return this;
    }

    public CustomSlotWidget setChangeListener(Runnable changeListener) {
     ...
     */
    public CustomSlotWidget setBackgroundTexture(IGuiTexture... backgroundTexture) {
        this.backgroundTexture = backgroundTexture;
        return this;
    }

    public CustomSlotWidget setLocationInfo(boolean isPlayerInventory, boolean isHotbarSlot) {
        this.locationInfo = new SlotLocationInfo(isPlayerInventory, isHotbarSlot);
        return this;
    }

    public CustomSlotWidget setTooltipText(String tooltipText, Object... args) {
    ...
    public boolean isEnabled() {
        return this.isActive() && isVisible() && displaySupplier.getAsBoolean();
    }
    ...
    protected class WidgetSlot extends Slot implements ISlotWidget {
        ...
        public boolean isItemValid(@Nonnull ItemStack stack) {
            return CustomSlotWidget.this.canPutStack(stack) && super.isItemValid(stack);
        }

        @Override
        public boolean canTakeStack(@Nonnull EntityPlayer playerIn) {
            return CustomSlotWidget.this.canTakeStack(playerIn) && super.canTakeStack(playerIn);
        }
        ...
        @Override
        public void onSlotChanged() {
            CustomSlotWidget.this.onSlotChanged();
        }

        @Override
        public boolean isEnabled() {
            return CustomSlotWidget.this.isEnabled();
        }
    }
    ...
    public class WidgetSlotItemHandler extends SlotItemHandler implements ISlotWidget {
        ...
        public boolean canTakeStack(EntityPlayer playerIn) {
            GTLog.logger.info(CustomSlotWidget.this.name + " canTakeStack init");
            return CustomSlotWidget.this.canTakeStack(playerIn) && super.canTakeStack(playerIn);
        }
